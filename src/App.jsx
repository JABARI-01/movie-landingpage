    ...
    <div className="min-h-screen flex items-center justify-center bg-black overflow-hidden">
      {loading ? (
        ...
        >
          ...
          <motion.h1
            className="relative text-5xl sm:text-6xl font-extrabold bg-gradient-to-r from-red-500 via-red-600 to-red-700 bg-clip-text text-transparent drop-shadow-[0_0_10px_rgba(255,0,0,0.4)]"
          ...
          <motion.button
            className="relative mt-10 px-10 py-4 text-lg font-semibold rounded-xl bg-gradient-to-r from-red-600 to-red-700 shadow-lg hover:shadow-red-700/50 transition-all duration-300 hover:scale-105"
